...
void main(){
  runApp(ItemList(items: TransactedItems));
}
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.of(context).pushNamed('prop_overview');
                    },
                    child: Text('Rent'),
...
List<ItemCard> TransactedItems = [
  ...
  ItemCard(
    imagePath: 'assets/house3.jpg',
    title: 'Holten (2 Bedrooms)',
    isFavourite: true,
  ),
  ItemCard(
    imagePath: 'assets/house2.jpg',
    title: 'perfect place (2 Bedrooms)',
    isFavourite: false,
  ),
...
class ItemListProvider extends ChangeNotifier {
  final List<ItemCard> _items = TransactedItems;
